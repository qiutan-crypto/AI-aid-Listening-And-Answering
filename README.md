...
2. 在「我的资料」里**上传文件**（PDF、Word .docx、TXT、Markdown），或者点「粘贴文字」直接粘贴。建议上传：
   ...
   - 这次面试的职位描述（JD）
   - 自己准备好的自我介绍、常见问题的回答
3. 面试官提问时，AI 会**按你的资料**写出第一人称的回答（"I ..."），拆成 3~6 句短句，每句带中文意思，方便你一句一句说。行为面试题（"Tell me about a time..."）按 STAR 结构回答。
4. 资料里**没有提到**的问题，AI 会用一般知识回答，需要个人细节的地方用 `[your example]` 这样的占位符，并在【回答思路】里注明资料里没有相关内容。AI 不会编造你的经历。
